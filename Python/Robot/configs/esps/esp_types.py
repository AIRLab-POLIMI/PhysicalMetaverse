...
esp_value_types = {
    ...
    ESP_VALUE_TYPE_KEYS.RIGHT.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.RIGHT.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.LEFT.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.LEFT.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
