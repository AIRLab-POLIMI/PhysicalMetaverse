...
#define MIN_ANGLE_HEAD_BEAK_T1 15
#define MAX_ANGLE_HEAD_BEAK_T1 80
#define MIN_ANGLE_HEAD_BODY_T 75
#define MAX_ANGLE_HEAD_BODY_T 140

//TAIL ANGLES
#define MIN_ANGLE_TAIL_BEAK_T2 60
#define MAX_ANGLE_TAIL_BEAK_T2 100
#define MIN_ANGLE_TAIL_BEAK_P 5
#define MAX_ANGLE_TAIL_BEAK_P 175
#define MIN_ANGLE_TAIL_BEAK_T1 10
#define MAX_ANGLE_TAIL_BEAK_T1 110
#define MIN_ANGLE_TAIL_NECK_T 80
#define MAX_ANGLE_TAIL_NECK_T 140
...
void set_servos_pos() {
  ...
  T_TN_angle = set_angle_perc(T_UD_angle, servo_tail_neck, MIN_ANGLE_TAIL_BEAK_T2, MAX_ANGLE_TAIL_BEAK_T2, MIN_ANGLE_TAIL_NECK_T, MAX_ANGLE_TAIL_NECK_T, true);
  ...
  write_serial("[ARDUINO] TILT 1 "+ String(T_T1_angle));
