...
class Control:
    def __init__(self,
        ...
        # Definisci il nome del file basato su variabili o valori specifici del programma
        
        #timestamp=datetime.datetime.now().timestamp()
        #datetime.datetime.fromtimestamp(timestamp)
        self.nome_file = "output_" + str(datetime.datetime.now(tz=timezone).strftime("%Y-%m-%d_%H:%M:%S")) + ".txt"

        # Crea il percorso completo della directory di destinazione
        self.directory_destinazione = os.path.join(self.current_directory, "logs")
        ...
        self.percorso_file = os.path.join(self.directory_destinazione, self.nome_file)
...
#------------------------------------------------------------------------------------------
            ...
            if string_msg is not None and string_msg:
                ...
                timestamp = datetime.datetime.now(tz=timezone).strftime("%H:%M:%S")
                


                # Apri il file in modalità scrittura
                with open(self.percorso_file, "a") as file:
                # Scrivi il timestamp nel file
                    file.write(str(timestamp) + " : ")
                    file.write(string_msg + "\n")

                print("Scrittura completata. Il file", self.percorso_file, "è stato creato nella directory 'logs'.")
