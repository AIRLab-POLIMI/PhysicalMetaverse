            ...
            while True:
                ...
                if line is not None:
                    ...
                    if line == "touched" or line == ".":
                        self.NETWORKING_CHANNEL.write_udp(int_to_bytes(1), ESP_CAP_SENSOR, 4210)
                    else:
                        self.NETWORKING_CHANNEL.write_udp(int_to_bytes(0), ESP_CAP_SENSOR, 4210)
