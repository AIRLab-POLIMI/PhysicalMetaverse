...
def add_esp_channels():
    ...
    #control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.ANGLE_X.value, DofName.HEAD_UD.value.key, True)
    #control.on_new_config_rcv(cap_s, ESP_VALUE_TYPE_KEYS.ANGLE_Y.value, DofName.STRAFE.value.key, True)
    #control.on_new_config_rcv(cap_s, ESP_VALUE_TYPE_KEYS.ANGLE_Z.value, DofName.ANGULAR.value.key, True)

    #control.on_new_config_rcv(test_ip_3, ESP_VALUE_TYPE_KEYS.MPX.value, DofName.HEAD_BODY_T.value.key, True)

    control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.ANGLE_X.value, DofName.HEAD_BF.value.key, True)
    control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.ANGLE_Y.value, DofName.HEAD_UD.value.key, True)
    control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.ANGLE_Z.value, DofName.HEAD_LR.value.key, True)
    control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.GYRO_X.value, DofName.TAIL_BF.value.key, True)
    control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.GYRO_Y.value, DofName.TAIL_UD.value.key, True)
    control.on_new_config_rcv("192.168.0.100", ESP_VALUE_TYPE_KEYS.GYRO_Z.value, DofName.TAIL_LR.value.key, True)
