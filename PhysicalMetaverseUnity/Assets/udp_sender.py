...
if __name__ == "__main__":
    udp_address = "192.168.0.103"  # Replace this with the UDP address you want to send the message to
    udp_port = 40616  # Replace this with the UDP port you want to use
    while True:
